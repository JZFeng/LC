...
public class RemoveDupfromSortedArrayII
{
    ...
    public static int removeDuplicatesII(int[] nums)
    {
        ...
        // index is the end of the new array, also is the position that can accept the number that appears less than
        // twice.
        // i is the regular pointer to go through the array.
        // nums[index-2] is the last number that appears less than twice.(2 included)
